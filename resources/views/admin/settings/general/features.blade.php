                ...
                <div class="mb-5">
                    ...
                    <div class="form-group">
                        ...
                        <select name="value[course_live_stream_type]" class="form-control">
                           <option value="single" {{ (!empty($itemValue) and !empty($itemValue['course_live_stream_type']) and $itemValue['course_live_stream_type'] == 'single') ? 'selected="selected"' : '' }}>{{ trans('single') }}</option>
                           <option value="multiple" {{ (!empty($itemValue) and !empty($itemValue['course_live_stream_type']) and $itemValue['course_live_stream_type'] == 'multiple') ? 'selected="selected"' : '' }}>{{ trans('multiple') }}</option>
                        </select><label class="label"></label>
                    </div>
                </div>
